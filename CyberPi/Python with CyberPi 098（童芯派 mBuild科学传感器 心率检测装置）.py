...
def heartbeat ():
    ...
    cyberpi.display.show_label('心率测量中', 16, "center")
...
while not cyberpi.wifi.is_connect():
    pass
cyberpi.display.set_brush(0, 0, 255)
cyberpi.display.show_label('童芯智慧医疗', 16, "center")
time.sleep(3)
cyberpi.console.clear()
cyberpi.display.show_label('童芯心率检测仪', 16, "center")
time.sleep(1)
basic()
...
while True:
    ...
    if cyberpi.controller.is_press('up'):
        ...
        count = 1
        if len(beat_list) < 2:
            cyberpi.display.show_label('数据量不足', 16, "center")
        else:
